%0 tcolorbox with icon: https://tex.stackexchange.com/a/570933/6758
...
%\addtocontents{toc}{\textbf{Startovací balíček}}
%thispagestyle{start-session}
	...
	\def\pagePracticeLog{
		...
		\subsection{Záznam cvičení \normalPencilLeftDown}
			\ifplastex
				...
				\end{tabular}
			\else
				\def\myStrut{\rule{0pt}{\dimexpr(\pagewidth-10em-2cm-6em)/7}} % {.07\textheight}}
				\footnotesize
...
\cleardoublepage
\section{Všímavost vs. autopilot}
	...
	\def\recommendedPractices#1#2#3#4{
		%\subsection{Doporučená cvičení}
		%Doporučená cvičení do příště:
			%\begin{description*}
				%\vskip0pt plus2em
				%\par\textbf{Formální cvičení — plánovaná:}
			\begin{tcolorbox}[title={Formální cvičení, plánovaná},parbox=false]
				...
				\tcbsubtitle{Neformální cvičení, za pochodu}
					...
					\else
						\begin{itemize*}
							\item \textbf{Všímavé okamžiky:} #2
							\item \textbf{Všímavé zvládání obtíží:} #3
							\item \textbf{Všímavé činnosti:} #4
						\end{itemize*}
					\fi
			\end{tcolorbox}
			%\end{description*}
	...
	\summaryAndPractices{
			...
			\item napojení na sebe; \item \textsc{Brzda}.
		}{
			Náhodně během dne se zastavujte a napojujte se na sebe.
		}{
			Používejte \textsc{Brzd}u, když se objeví obtíže.
		}{
			Vyzkoušejte všímavé jedení: při každém jídle snězte jedno spousto všímavě. Přineste v tu chvíli plnou pozornost k jídlu a žité zkušenosti jedení.
		}
...
\cleardoublepage
\section{Pocity jsou jako hosté}
	\thispagestyle{start-session}
	\summaryAndPractices{
			...
			\item napojení na sebe; \item všímavost k pocitům (s přečtením si \emph{Domu pro hosty}).
		}{
			Náhodně během dne se zastavujte a napojujte se na sebe. Všimněte si pocitů, pokud nějaké vnímáte, s otevřeností a přijetím.
		}{
			Používejte \textsc{Brzd}u, když se objeví obtíže. Cvičte přijímání svých pocitů a dovolte si je cítit.
		}{
			Zkoušejte všímavou sprchu či koupel. Přineste v tu chvíli plnou pozornost k tomu, jak se sprchujete či koupete. Napojte se na svých pět smyslů.
		}
	\pageGuesthouse
	\pagePracticeLog

\cleardoublepage
\section{Laskavost k sobě}
	\thispagestyle{start-session}
	\summaryAndPractices{
			...
			\item napojení na sebe; \item meditace laskavosti.
		}{
			Náhodně během dne se zastavujte a napojujte se na sebe.
		}{
			Používejte \textsc{Brzd}u, když se objeví obtíže. Cvičte laskavost k sobě a sebesoucit.
		}{
			Zkoušejte všímavé čištění zubů. Přineste v tu chvíli k čištění zubů plnou pozornost. Napojte se na svých pět smyslů.
		}
	\pagePracticeLog

\cleardoublepage
\section[Na spouštěče aktivně — ne reaktivně]{Na spouštěče aktivně —\\ ne reaktivně}
	\thispagestyle{start-session}
	\summaryAndPractices{
			...
			Používejte \textsc{Brzd}u, když se objeví obtíže či spouštěče.
		}{
			Zkoušejte všímavé poslouchání. Zastavte se a jen vnímejte zvuky z okolí. Zkouštejte to venku i uvnitř. Jinou možností je všímavě poslouchat hudbu. Pusťte si něco, co máte rádi, a změřte pozornost na to, jak vnímáte přicházející zvuky.
		}
...
\cleardoublepage
\section{Vidět myšlenky jako myšlenky}
	\thispagestyle{start-session}
	\summaryAndPractices{
			...
			\item napojení na sebe.
		}{
			Náhodně během dne se zastavujte a napojujte se na sebe.
		}{
			Používejte \textsc{Brzd}u, když se objeví obtíže.
		}{
			Zkoušejte všímavou chůzi. Vneste plnou pozornost do toho, jak jdete. Všímejte si při chůzi všech tělesných vjemů.
		}
	\clearpage
...
\section{Jízda na vlně nutkání}
	...
	\summaryAndPractices{
			...
			Používejte \textsc{Brzd}u, když se objeví obtíže či nutkání.
		}{
			Zkoušejte všímavé dívání se. Zastavte se a otevřete se všem zrakovým vjemům. Všimněte si barev, tvarů, světla a stínů. Zkoušejte to venku. I uvnitř.
		}
	\pagePracticeLog

\cleardoublepage
\section{Následovat své hodnoty}
	\thispagestyle{start-session}
	\summaryAndPractices{
			...
			\item napojení na sebe;\item meditace o hodnotách.
		}{
			Náhodně během dne se zastavujte a napojujte se na sebe.
		}{
			Používejte \textsc{Brzd}u, když se objeví obtíže. Zvažte své hodnoty a jak se všímavě rozhodovat, abyste s nimi zůstávali v souladu.
		}{
			Cvičte všímavost při běžných domácích pracech, např. mytí nádobí či skládání prádla. Vneste zvídavé uvědomování do toho, co právě děláte. Napojte se na své smysly (např. co vidím, zvuky, doteky, pachy).
		}
...
\cleardoublepage
\section{Prozkoumat své potřeby}
	\thispagestyle{start-session}
	\summaryAndPractices{
			...
			\item napojení na sebe;\item meditace zkoumání potřeb.
		}{
			Náhodně během dne se zastavujte a napojujte se na sebe.
		}{
			Používejte \textsc{Brzd}u, když se objeví obtíže či nutkání. Zvažte své potřeby. Zeptejte se sami sebe: \toSelf{Co v tuto chvíli opravdu potřebuji?}
		}{
			Cvičte všímavost k přírodě, když jste venku. Vneste zvídavé uvědomování do různých prožitků v přírodě, když vnímáte např. oblohu, oblaka, vítr, rostliny, stromy či zvířata.
		}
	\pagePracticeLog

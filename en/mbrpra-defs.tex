...
\newcommand{\soberSpaceEmpty}[1]{
	...
	\node(b2)[sober,below=of b1]{\soberName{Observe.} \bodyFeelingsMind: \Blank{4}};
	\node(b3)[sober,below=of b2]{\soberName{Breathe.} \Blank{2}};
	\node(b4)[sober,below=of b3]{\soberName{Expand.} \bodyFeelingsMind: \Blank{4}};
...
\def\pageSOBERown#1#2{
	...
	\vskip-1em #1{}
		How can you use the \textsc{Sober} space in the situation? For each step of the \textsc{Sober} write out what you would do/what you would notice in your own words. \par
	\vskip0pt minus1cm

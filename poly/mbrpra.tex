...
% this is make gettext no-op, \csname ensures it does not get parsed by the extractor as a string to be translated
\long\expandafter\def\csname gettext\endcsname#1{#1}
\long\expandafter\def\csname pgettext\endcsname#1#2{#2}
...
\usepackage[left=1.5cm,right=2cm,top=2.5cm,bottom=2.5cm,headheight=14pt]{geometry}

\usepackage{polyglossia}
\setdefaultlanguage{\pgettext{polyglossia}{english}}
\usepackage{csquotes}
\usepackage{booktabs}
...
\setlist[description*]{style=unboxed,
	...
	% itemsep=.5em,nosep}
	nosep,itemsep=\parskip,leftmargin=0pt
}
...
\title{\gettext{Mindfulness-Based Relapse Prevention (Rolling Admission)}}
\date{2023}
\author{\gettext{Corey Roos \&al \href{https://PracticeMBRP.com}{PracticeMBRP.com}}}
